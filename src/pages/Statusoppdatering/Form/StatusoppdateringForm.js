  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit}>
        ...
        />
        <Input label="Skriv inn lenke:" name="link" value={values.link} onChange={(e) => handleChange(e)} />
        <Input label="Skriv inn sakstema:" name="sakstema" value={values.sakstema} onChange={(e) => handleChange(e)} />
        <Input
